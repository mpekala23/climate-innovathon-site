  ...
  (() => {
    ...
    r.VantaBase = class {
      ...
      triggerMouseMove(e, t) {
        ...
        typeof this.onMouseMove === 'function' && this.onMouseMove(i, n);
      }
    ...
    const l = r.VantaBase;
    const h = typeof window === 'object' && window.THREE;
    let {
      Camera: c,
    ...
    const x = function (e, t, i, n) {
      ...
      s.add(h),
        ...
        (this.init = function () {
          ...
          for (let n = 0; n < this.variables.length; n++) {
            ...
            if (o.dependencies !== null)
              for (let a = 0; a < o.dependencies.length; a++) {
                const l = o.dependencies[a];
                if (l.name !== o.name) {
        ...
        (this.compute = function () {
          for (
            var e = this.currentTextureIndex,
              t = this.currentTextureIndex === 0 ? 1 : 0,
              i = 0,
            ...
            if (o.dependencies !== null)
              for (
                let s = o.material.uniforms, r = 0, a = o.dependencies.length;
                r < a;
                r++
              ) {
                const l = o.dependencies[r];
        ...
        (this.getAlternateRenderTarget = function (e) {
          return e.renderTargets[this.currentTextureIndex === 0 ? 1 : 0];
        }),
        ...
        (this.createTexture = function () {
          const i = new Float32Array(e * t * 4);
    ...
    let T = typeof window === 'object' && window.THREE;
    const M = !i();
    let z = 32;
    let S = z * z;
    const C = 800;
      ...
      constructor(e) {
        ...
        (this.position = new T.Vector3()),
          ...
          (this.repulse = function (e) {
            const i = this.position.distanceTo(e);
            if (i < 150) {
    ...
    class E extends l {
        ...
        !(function (e) {
          ...
          (() => {
            ...
            for (; i < n; ) {
              ...
              const o = Math.random() * C - 400;
              const s = Math.random() * C - 400;
              (t[i + 0] = n),
                (t[i + 1] = o),
                (t[i + 2] = s),
                (t[i + 3] = 1),
      ...
      initGpgpuBirds() {
        const e = ((e) => {
          const t = new T.BufferGeometry();
          e.quantity && ((z = 2 ** e.quantity), (S = z * z));
          const i = 3 * S;
          const n = 3 * i;
          const o = new T.BufferAttribute(new Float32Array(3 * n), 3);
          const s = new T.BufferAttribute(new Float32Array(3 * n), 3);
          const r = new T.BufferAttribute(new Float32Array(2 * n), 2);
          const a = new T.BufferAttribute(new Float32Array(n), 1);
          ...
          const c = e.wingSpan || 20;
          const d = e.birdSize || 1;
          for (let e = 0; e < S; e++)
          ...
          for (l = 0; l < 3 * i; l++) {
            ...
            const o = ~~(l / 9) / S;
            const h = o.toString();
            const c = e.colorMode.indexOf('Gradient') != -1;
            let d;
      ...
      getNewCol(e) {
        ...
        const i = t.color1 != null ? t.color1 : 0;
        const n = t.color2 != null ? t.color2 : 0;
        const o = new T.Color(i);
        const s = new T.Color(n);
        let r;
        let a;
        if (
          ((a = t.colorMode.indexOf('Gradient') != -1 ? Math.random() : e),
          t.colorMode.indexOf('variance') == 0)
        ) {
          const e = (o.r + Math.random() * s.r).clamp(0, 1);
          const t = (o.g + Math.random() * s.g).clamp(0, 1);
          const i = (o.b + Math.random() * s.b).clamp(0, 1);
          r = new T.Color(e, t, i);
        } else
          r =
            t.colorMode.indexOf('mix') == 0
              ? new T.Color(i + a * n)
              : o.lerp(s, a);
        return r;
      }
      ...
      onInit() {
        ...
        if (M)
          ...
          for (let s = 0; s < l; s++) {
            ...
            const h = i.colorMode.indexOf('Gradient') != -1;
            const c = V(i);
            const d = c.attributes.position.length;
            const u = new T.BufferAttribute(new Float32Array(d), 3);
            if (h)
